"""
Django settings for peer_review_hub project.
...
ROOT_URLCONF = 'peer_review_hub.urls'
...
WSGI_APPLICATION = 'peer_review_hub.wsgi.application'


# Database - configured in db_config.py for production/development flexibility
...
# Optional: For sending actual emails (configure these for production)
...
DEFAULT_FROM_EMAIL = 'noreply@reviewverse.local'
